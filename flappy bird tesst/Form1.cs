    ...
    public partial class Form1 : Form
    {
        ...
        private PictureBox CreateSkinThumb(Image img, BirdSkin tag)
        {
            ...
            var pb = new PictureBox
            {
                ...
                SizeMode = PictureBoxSizeMode.StretchImage, // fixed size prevents autosize-induced flicker
        ...
        private void BuildSkinPanel()
        {
            ...
            EnableDoubleBuffer(skinFlow);

            skinFlow.SuspendLayout();
        ...
        private void LayoutSkinPanel()
        {
            ...
            skinPlate.PerformLayout();
            var pref = skinPlate.PreferredSize;
            int targetW = pref.Width;
            int targetH = pref.Height;

            skinPlate.Left = (ClientSize.Width - targetW) / 2;
            int playH = Math.Max(0, ClientSize.Height - ground.Height);
            skinPlate.Top = Math.Max(10, (playH - targetH) / 2);
        }
        ...
        private void InitializeGame()
        {
            ...
            // Overlays
            if (overlayMessage != null) overlayMessage.Visible = false; // keep hidden until skin chosen
